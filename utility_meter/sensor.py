...
from .const import (
    ...
    DEFAULT, ALTERNATE, 
    CONF_SOURCE_SENSOR, CONF_METER_TYPE, CONF_METER_MODE, CONF_METER_OFFSET,
...
async def async_setup_platform(
    ...
    for conf in discovery_info:
        ...
        conf_meter_mode = hass.data[DATA_UTILITY][meter].get(CONF_METER_MODE)
...
class UtilityMeterSensor(RestoreEntity):
    ...
    def __init__(self, source_entity, name, meter_type, meter_mode, meter_offset,
        ...
        try:
            if self._mode == DEFAULT:
              ...
              if self._period_open == '0':
                self._period_open = str(new_state.state)
              self._state = Decimal(new_state.state) - Decimal(self._period_open)
    ...
    async def async_added_to_hass(self):
        ...
        if state:
            ...
            self._period_open = state.attributes.get(ATTR_PERIOD_OPEN)
    ...
    def device_state_attributes(self):
        ...
        state_attr = {
            ...
            ATTR_PERIOD_OPEN: self._period_open,
